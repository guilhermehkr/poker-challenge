...
public class CardTest {
    ...
    private final static Integer CARD_LESS_THAN_ANOTHER_CARD = -1;
    private final static Integer CARD_EQUALS_TO_ANOTHER_CARD = 0;
    private final static Integer CARD_GREATER_THAN_ANOTHER_CARD = 1;
        ...
        return new Object[][]{
                {
                        ...
                        null,
                        FALSE,
                        CARD_GREATER_THAN_ANOTHER_CARD
                },
                {
                ...
                },
                {
                        ...
                        new Card(ACE_NUMBER, ANY_SUIT),
                        FALSE,
                        CARD_LESS_THAN_ANOTHER_CARD
                },
                {
                        new Card(QUEEN_NUMBER, ANY_SUIT),
                        new Card(QUEEN_NUMBER, EMPTY),
                        FALSE,
                        CARD_EQUALS_TO_ANOTHER_CARD
                },
                {
                        new Card(null, null),
                        new Card(null, null),
    ...
    public void shouldCompareTwoCards(Card card,
                                      Card anotherCard,
        ...
        if (isEqual) {
            assertThat(card.hashCode(), is(anotherCard.hashCode()));
        }
    }
}